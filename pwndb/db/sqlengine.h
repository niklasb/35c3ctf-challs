...
struct SqlTable {
  ...
  void insert(SqlRecord record) {
    ...
    //cerr << "Inserting "; for (auto x : row) cerr << x << ", "; cerr << endl;
...
//struct EmptyCursor : public SqlCursor {
  //virtual bool valid() const override { return false; }
  //virtual void next() override {}
  //virtual uint64_t row_index() const override { return 0; }
  //virtual const SqlRecord* value() const override { return nullptr; }
//};
